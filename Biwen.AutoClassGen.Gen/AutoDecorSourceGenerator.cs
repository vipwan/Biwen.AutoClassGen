...
namespace Biwen.AutoClassGen
{
    ...
    public class AutoDecorSourceGenerator : IIncrementalGenerator
    {
            ...
            SourceProductionContext context)
        {
            ...
            //去除重复的Key,只保留最后一项:
            ofImpls = [.. ofImpls.GroupBy(x => x.Key).ToDictionary(x => x.Key, x => x.Last().Value)];
            ...
            //envStringBuilder.AppendLine("{");
            envStringBuilder.AppendLine($"[global::System.CodeDom.Compiler.GeneratedCode(\"{ThisAssembly.Product}\", \"{ThisAssembly.FileVersion}\")]");
